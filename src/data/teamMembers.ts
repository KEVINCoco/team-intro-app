...
export const teamMembers: TeamMember[] = [
    ...
    },
    {
        ...
        title: '胡浩波',
        position: '物理组长',
        description: '高级工程师、中山大学在读研究生。从事放射治疗物理十余年，有着丰富的放射物理临床经验，擅长放疗新技术开发，临床应用及质量保证，如三维适形放疗(3DCRT)、调强放(IMRT/VMAT)、立体定向放疗(SBRT/SRS)和影像引导放疗(IGRT)，伽马刀治疗， 质子治疗， 自适应治疗等，并在美国AAPM和中国抗癌协会等国内外学术期刊上发表摘要、论文多篇，主持在研惠州市科技项目一项，参与翻译《质子治疗：适应症、技术与疗效》一书，并拥有伽马刀质控模体专利一项。',
        // 学术兼职
        academicList: [
            {
                department: '广东省医学装备学会放射治疗装备技术分会',
                duty: '委员',
            },
            {
                department: '广东省抗癌协会医学物理技术专业委员会',
                duty: '委员',
            },
        ]
    },
